...
public class LabirintoBuilderTest {
	...
	public void testTrilocaleConStanzaDuplicata() {
				...
				.getLabirinto();
		assertTrue(labirintoBuilder.getMappaStanza().size()<=2);
	}
	...
	public void testAggiuntaAttrezziAStanze_AppenaAggiunte() {
		...
		labirintoBuilder
				...
				.addAttrezzo(nomeAttrezzo, peso)
				.getLabirinto();
		assertTrue(this.labirintoBuilder.getMappaStanza().get(nomeStanza).getAttrezzi().containsValue(new Attrezzo (nomeAttrezzo,peso)));
		assertEquals(new Attrezzo(nomeAttrezzo,peso),this.labirintoBuilder.getMappaStanza().get(nomeStanza).getAttrezzo(nomeAttrezzo));
	}
	...
	public void testAggiuntaAttrezzoAStanze_MoltepliciAttrezziStessaStanza() {
		...
		Map<String, Stanza> listaStanze = labirintoBuilder.getMappaStanza();
	...
	public void testLabirintoConStanzaBloccata_ConPassepartout() {
		...
		assertEquals(stanzaVincente,labirintoBuilder.getMappaStanza().get("stanza bloccata").getStanzaAdiacente("nord"));	
	}
	...
	public void testLabirintoConStanzaBloccata_SenzaPassepartout() {
		...
		assertEquals(stanzaBloccata,labirintoBuilder.getMappaStanza().get("stanza bloccata").getStanzaAdiacente("nord"));
	}
}
